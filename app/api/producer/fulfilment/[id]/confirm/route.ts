...
//////////////////////////////////////////////////////
// POST — Producer acknowledges fulfilment task
//
  ...
  try {
    ...
    if (task.status !== "AWAITING_CONFIRMATION") {
      return NextResponse.json(
        { error: `Cannot confirm task with status ${task.status}. Expected AWAITING_CONFIRMATION.` },
        { status: 400 }
      )
    }
    ...
    console.error("[PRODUCER_FULFILMENT_CONFIRM]", error)
