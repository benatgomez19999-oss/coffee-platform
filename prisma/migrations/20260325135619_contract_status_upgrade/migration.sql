/*
  ...
  - The values [CONFIRMED] on the enum `ContractStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ContractStatus_new" AS ENUM ('PENDING', 'AWAITING_SIGNATURE', 'SIGNED', 'PAYMENT_PENDING', 'ACTIVE', 'COMPLETED', 'CANCELLED');
